...
system("perl arrayTB.pl -width 16 -dimension 4 -outfile system_TB_sv.sv");
system("mv system_TB_sv.sv ../accelerator_IP_systolicarray/accelerator_IP_systolicarray.srcs/sources_1/new/");
